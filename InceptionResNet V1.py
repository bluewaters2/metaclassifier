...
def InceptionResnetv1(dataset):
  for image in range(0, len(dataset)):
    model = InceptionResNetV1(weights='imagenet', include_top=False, input_tensor=Input(shape=(299,299,3)))  # Exclude the top classification layer
